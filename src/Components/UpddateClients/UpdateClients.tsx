      ...
      <form>
        <section>
          <div>
            ...
            <input type="text" id="name" placeholder="Ex: João Pedro" />
          </div>
          <div>
        ...
        <section>
          <div>
            ...
            <input type="text" id="dateOfBirth" placeholder="Ex: 01/01/2000" />
          </div>
          <div>
            <label htmlFor="email">&nbsp;Email:</label>
            <input type="text" id="email" placeholder="Ex: 2lG7I@example.com" />
          </div>
        </section>
        <section>
          <div>
          ...
          <div>
            ...
            <input type="text" id="status" placeholder="Ex: ativo" />
          </div>
        </section>
        <section>
          <div>
            <label htmlFor="fgtsBalance">&nbsp;Saldo do FGTS (R$):</label>
            <input type="number" id="fgtsBalance" placeholder="Ex: 1000.0" />
          </div>
          <div>
            <label htmlFor="balanceWithdraw">&nbsp;Saldo Sacado (R$):</label>
            <input type="number" id="balanceWithdraw" placeholder="Ex: 0.0" />
          </div>
        </section>
        <section>
          <div>
        ...
        <section>
          <div>
            ...
            <input type="text" id="autorization" placeholder="Ex: Sim" />
          </div>
          <div>
        ...
        <section>
          <div>
            ...
            <input type="text" id="withdrawDate" placeholder="Ex: 01/01/2023" />
          </div>
          <div>
